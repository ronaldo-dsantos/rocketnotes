...
- Para uma experiência completa, é recomendado também clonar e configurar o backend da aplicação disponível em [api-rocketnotes](https://github.com/ronaldo-dsantos/api-rocketnotes/) 
